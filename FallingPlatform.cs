...
{
    public float fallDelay = 2f;//Delay before Platform falls 
    private Vector3 startPosition;//Where the platform starts 
    ...
    //If the player touches the platform it will check the tag and drop
